...
%
  ...
  if Stage > 1  
    if ob == 1
         OutputSignal=[FFTOutput(NumberOfSubbands/2:-1:1) FFTOutput(NumberOfSubbands:-1:NumberOfSubbands/2)];
    ...
    %    OutputSignal = fftshift(FFTOutput);
      ...
      OutputSignal = [OutputSignal; [FFTOutput(NumberOfSubbands/2:-1:1) FFTOutput(NumberOfSubbands:-1:NumberOfSubbands/2) ]];
