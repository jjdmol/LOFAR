function SDP(DataLength, NumberOfAntennas, NumberOfSubbands, ...
             SubbandFilterLength, Averaging, Frequency, SigmaThr)
...
FlaggingCube = TimeFrequencyAnalyzer(SelectedSubbandSignals, NewDataLength(2), NumberOfAntennas, length(SubbandSelector), Averaging, Frequency, SigmaThr);
