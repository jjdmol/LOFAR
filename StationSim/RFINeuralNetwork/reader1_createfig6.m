...
HMainFig6 = figure(...
 ...
 set(HMainFig6,'defaultaxesposition',[LeftBorder BottomBorder TotalWidth TotalHeight])
 
 %==================================
 % Define 3D subplot properties
 HThreeDFig6 = subplot(2,2,1);
 set(gca, ...
    'Units','normalized', ...
    'Position',[LeftBorder BottomBorder+Lin2Height+FigSpace Col1Width Lin1Height]);
 %==================================
 % Define time plot
 HTimeFig6 = subplot(2,2,2);
 set(gca, ...
    'Units','normalized', ...
...
% Affichage label 
CompPos = [CompLeft CompBottom CompWidth*1 CompHeight];
h = uicontrol( ...
   'Style','text', ...
   'Units','normalized', ...
   'Position',CompPos, ...
   'Horiz','left', ...
   'String','Classe choisie :', ...
   'Interruptible','off', ...
   'BackgroundColor',CompBackGroundColor , ...
   'ForegroundColor','white');
...
callbackStr='reader1_scale6';
HBtnColorBar6=uicontrol( ...
   'Style','pushbutton', ...
   'Units','normalized', ...
   'Position',CompPos, ...
   'String',CompStr, ...
