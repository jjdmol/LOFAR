//#  -*- mode: c++ -*-
//#
//#  SetDatastreamCmd.h: enable/disable datastream to cep.
//#
//#  Copyright (C) 2009
...
//#
//#  $Id: SetDatastreamCmd.h 12869 2009-03-12 11:19:55Z overeem $

#ifndef SETDATASTREAMCMD_H_
#define SETDATASTREAMCMD_H_
...
class SetDatastreamCmd : public Command
{
public:
	// Constructors for a SetDatastreamCmd object.
	SetDatastreamCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);

	// Destructor for SetDatastreamCmd. */
	virtual ~SetDatastreamCmd();
...
private:
	...
	RSPSetdatastreamEvent* itsEvent;
};

  }; // namespace RSP
}; // namespace LOFAR
     
#endif /* SETDATASTREAMCMD_H_ */
