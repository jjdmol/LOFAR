...
PROPERTYCONFIG_ITEM(PROPNAME_STATUS, GCF_READABLE_PROP, "0")
PROPERTYCONFIG_ITEM(PROPNAME_VDDVCCEN, GCF_WRITABLE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_VHENABLE, GCF_WRITABLE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_VLENABLE, GCF_WRITABLE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_FILSELB, GCF_WRITABLE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_FILSELA, GCF_WRITABLE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_BANDSEL, GCF_WRITABLE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_HBAENABLE, GCF_WRITABLE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_LBAENABLE, GCF_WRITABLE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_STATISTICSSUBBANDPOWER, GCF_READABLE_PROP, "")
PROPERTYCONFIG_ITEM(PROPNAME_STATISTICSBEAMLETPOWER, GCF_READABLE_PROP, "")
PROPERTYCONFIG_END
