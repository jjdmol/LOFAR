...
const int BIT_FILSEL0 = 3;
const int BIT_FILSEL1 = 4;
...
#define PROPNAME_FILSEL1         "filSel1"
#define PROPNAME_FILSEL0         "filSel0"
...
#define PROPNAME_XCSTATISTICS     "statisticsCrosslet"
#define PROPNAME_INTEGRATIONTIME "integrationTime"
#define PROPNAME_INTEGRATIONMETHOD "integrationMethod"
...
PROPERTYCONFIG_ITEM(PROPNAME_XCSTATISTICS, GCF_READABLE_PROP, "")
PROPERTYCONFIG_ITEM(PROPNAME_INTEGRATIONTIME, GCF_WRITABLE_PROP, 0) // 0 means no default
PROPERTYCONFIG_ITEM(PROPNAME_INTEGRATIONMETHOD, GCF_WRITABLE_PROP, 0) // 0 means no default
PROPERTYCONFIG_ITEM(PROPNAME_STABLE, GCF_READABLE_PROP, 0)
PROPERTYCONFIG_END
...
PROPERTYCONFIG_ITEM(PROPNAME_STATUS, GCF_READWRITE_PROP, "0")
PROPERTYCONFIG_ITEM(PROPNAME_FUNCTIONALITY, GCF_READABLE_PROP, "true")
PROPERTYCONFIG_ITEM(PROPNAME_VDDVCCEN, GCF_READWRITE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_VHENABLE, GCF_READWRITE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_VLENABLE, GCF_READWRITE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_FILSEL1, GCF_READWRITE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_FILSEL0, GCF_READWRITE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_BANDSEL, GCF_READWRITE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_HBAENABLE, GCF_READWRITE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_LBAENABLE, GCF_READWRITE_PROP, "false")
PROPERTYCONFIG_ITEM(PROPNAME_STATISTICSSUBBANDPOWER, GCF_READABLE_PROP, "")
PROPERTYCONFIG_ITEM(PROPNAME_STATISTICSBEAMLETPOWER, GCF_READABLE_PROP, "")
PROPERTYCONFIG_END
