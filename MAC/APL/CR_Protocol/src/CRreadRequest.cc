//#  CRreadRequest.cc: Serialisable structure holding read requests for TBBs
//#
//#  Copyright (C) 2011
...
// --- Output function --- 
ostream& CRreadRequest::print (ostream& os) const
{
	os << "ReadRequest(" << stationList << "," << rcuList << "," << readTime << "'" << timeBefore << "," << timeAfter << ")";
	return (os);
}
