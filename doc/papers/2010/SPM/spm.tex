...
+ well-known                 & + L2 prefetch unit               & + largest number of cores    & + random write access        & + explicit cache              \\
                             ...
                             &                                  &                              &                              & + power efficiency            \\
                             &                                  &                              &                              &                               \\
- few registers              & - double precision only   & - low PCI-e bandwidth        & - low PCI-e bandwidth        & - multiple parallelism levels \\
- no fma instruction                    & - expensive                      & - transfer slows down kernel &                              & - no increment in odd pipe    \\
