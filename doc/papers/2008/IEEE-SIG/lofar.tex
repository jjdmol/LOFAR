...
Figure~\ref{fig:concept} shows the processing chain of an apperture synthesis
array.
...
These challenges imply that for LOFAR exisiting processing strategies and algorithms must be reconsidered and new strategies and algorithms have to be developed. Therefore, the LOFAR offline processing is still a work in progress of which the current status is presented here.
