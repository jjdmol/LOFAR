...
\fixme{Ik heb de zin over lagere onderhouds kosten als gevolg het niet
hebben van bewegende delen weggelaten, omdat er bij LOFAR meer elektronica
kapot kan gaan.}
...
For at least two applications (\fixme{EoR and ?}), a larger FoV is required.
...
about \fixme{xxx}~m in diameter for the remote stations.
