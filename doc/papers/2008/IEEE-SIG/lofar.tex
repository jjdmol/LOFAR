...
Furthermore the WAN infrastructure from the field towards the central location is realized for all four stations

6 BG/L racks   
12 input machines
klein online cluster en offline cluster groeien mee met LOFAR

A lot of LBA commissioning observations have been done so far, while the HBA commissioning lags behind and is currently ongoing.
...
International stations showed interest in building stations as well and connecting with LOFAR. In this context the first LBA station, consisting of 96 antennas is currently operational in Effelsberg (Germany) and will be connected to the rest of the LOFAR system. For the international stations also stand alone modes will be supported. In this way those stations can participate in the full LOFAR configuration or operate in a local mode.
