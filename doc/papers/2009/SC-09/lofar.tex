...
Mode~\textsf{A} is the standard mode, TODO
...
Figure~\ref{fig:ion-performance-func-subbands} shows the performance breakdown
for 64~stations, 8-bit samples, and up to 496~subbands (the maximum station
data rate).
...
Figure~\ref{fig:cn-performance-func-stations} shows how the compute nodes spend
their time, as function of the number of stations.
...
44\%
\footnote{The FFT requires 8390~operations, 18\% less than an unoptimized
$5n\log n$ implementation.  Although an unoptimized FFT could achieve even
