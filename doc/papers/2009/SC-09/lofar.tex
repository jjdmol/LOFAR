...
efficient enough to exceed the LOFAR specifications by 50\%. We use several parts of our Blue Gene/P
...
pre- and postprocessing. Also, we use a custom network protocol called FCNP to be
