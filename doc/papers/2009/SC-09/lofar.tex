...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=5cm]{correlation-triangle.pdf}
\end{center}
...
These $2\times2$ tiles are correlated interwovenly.
...
making the memory subsytem a severe bottleneck.
The interwoven correlation computations also helps to hide the 5-cycle
