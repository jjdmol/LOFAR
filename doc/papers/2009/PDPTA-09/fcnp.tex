...
\begin{figure*}[t]
\includegraphics[width=\textwidth]{processing.eps}
...
\begin{center}
\includegraphics[width=.7\columnwidth]{station.eps}
\end{center}
...
\begin{figure}[h]
\includegraphics[width=\columnwidth]{pset.eps}
\caption{A pset.}
\label{fig:pset}
\end{figure}
...
\begin{figure}[h]
\subfigure[write.]{
  \includegraphics[width=.46\columnwidth]{FCNP-write.eps}
  \label{fig:FCNP-write}
}
\hfill
\subfigure[read.]{
  \includegraphics[width=.46\columnwidth]{FCNP-read.eps}
  \label{fig:FCNP-read}
}
...
\subfigure[Unshared bandwidth.]{
  \includegraphics[width=\columnwidth]{unfair.eps}
  \label{fig:unfair}
}
\end{vbox}
\vspace{5mm}
\subfigure[Shared bandwidth.]{
  \includegraphics[width=\columnwidth]{fair.eps}
  \label{fig:fair}
}
\end{center}
...
\subfigure[I/O~node to compute node.]{
  \includegraphics[width=.44\textwidth]{ion-to-cn-performance.eps}
  \label{fig:ion-to-cn-performance}
}
\hfill
\subfigure[Compute node to I/O~node.]{
  \includegraphics[width=.44\textwidth]{cn-to-ion-performance.eps}
