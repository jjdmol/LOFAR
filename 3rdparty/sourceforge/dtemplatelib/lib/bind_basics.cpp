...
void ETI_Map::build()
{
  ...
  (*this)[typeid(blob).name()] =
    TypeTranslation(typeid(blob).name(), C_BLOB, SQL_VARCHAR, SQL_C_CHAR, TypeTranslation::TYPE_COMPLEX, sizeof(blob));
#else
  (*this)[typeid(blob).name()] =
...
int GenericCmp(void *pMember1, void *pMember2, int typeId)
{
  ...
  case C_INT64: {
    ODBCINT64 *pULong1 = (ODBCINT64 *) pMember1;
    ODBCINT64 *pULong2 = (ODBCINT64 *) pMember2;
  ...
  case C_WCHAR_STAR: {
    wchar_t *pCStr1 = (wchar_t *) pMember1;
    wchar_t *pCStr2 = (wchar_t *) pMember2;

    return std_wcscmp(pCStr1, pCStr2);
  }
#endif
  case C_BOOL: {
    bool *pBool1 = (bool *) pMember1;
    bool *pBool2 = (bool *) pMember2;
  ...
  case C_BLOB: {
    blob *pStr1 = (blob *) pMember1;
    blob *pStr2 = (blob *) pMember2;
  ...
  case C_JTIME_C: {
    jtime_c *pTS1 = (jtime_c *) pMember1;
    jtime_c *pTS2 = (jtime_c *) pMember2;
  ...
  case C_TCSTRING: {
    fake_tcstring* pStr1 = (fake_tcstring*) pMember1;
    fake_tcstring* pStr2 = (fake_tcstring*) pMember2;
...
size_t GenericHash(void *pMember1, int typeId)
{
  // types supported: short, unsigned short, int, unsigned int,
  // long, unsigned long, double, float, struct TIMESTAMP_STRUCT,
  // TCHAR *, tstring, bool, TCHAR, STD_::wstring
