...
RETCODE str2jultm(const TCHAR *szDt, jtime_t *pjtime) {
	...
	std_tstrncpy(szDate, szDt, sizeof(szDate));
	szField[0] = std_tstrtok(szDate, _TEXT("-/., :"));
	szField[1] = std_tstrtok(NULL, _TEXT("-/., :"));
	szField[2] = std_tstrtok(NULL, _TEXT("-/., :"));
	szField[3] = std_tstrtok(NULL, _TEXT("-/., :"));
	szField[4] = std_tstrtok(NULL, _TEXT("-/., :"));
	szField[5] = std_tstrtok(NULL, _TEXT("-/., :"));
