...
#include "merant.h"
    ...
    tstring DBConnection::GetDBMSName() const
	{
     ...
     RETCODE rc = SQLGetInfo(hdbc, SQL_DBMS_NAME, &szDriverName, sizeof(szDriverName),
        &cbDummy);
    ...
    tstring DBConnection::GetDBMSVersion() const
	{
      ...
      TCHAR szDriverVer[200];
	  SWORD cbDummy;
	
	  RETCODE rc = SQLGetInfo(hdbc, SQL_DBMS_VER, &szDriverVer, sizeof(szDriverVer),
        &cbDummy);
