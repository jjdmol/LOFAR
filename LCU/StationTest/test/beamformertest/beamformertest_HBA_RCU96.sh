...
sleep 3
beamctl --array=HBA --rcumode=5 --rcus=48:49 --subbands=320:381 --beamlets=124:185 --direction=0,0,LOFAR_LMN&
sleep 3
beamctl --array=HBA --rcumode=5 --rcus=0:95 --subbands=320:381 --beamlets=186:247 --direction=0,0,LOFAR_LMN&
