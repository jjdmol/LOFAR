...
\lstdefinelanguage{pseudo}
{
    ...
    basicstyle={\fontencoding{T1}\fontfamily{pcr}\fontseries{m}\fontshape{sl}\fontsize{7}{8pt}\selectfont},
    keywordstyle={\fontencoding{T1}\fontfamily{pcr}\fontseries{b}\fontshape{sl}\fontsize{7}{8pt}\selectfont},
    commentstyle={\fontencoding{T1}\fontfamily{pcr}\fontseries{m}\fontshape{n}\fontsize{7}{8pt}\selectfont},
    sensitive=true
}
\begin{figure*}[t]
