...
compute cores and can exploit vector parallelism with the SSE instruction set.
...
platforms in more detail in~\cite{Nieuwpoort:09}, and the implementation of 
an imaging algorithm on many-core hardware in~\cite{gridding}. 
...
As explained in Section~\ref{sec:correlating}, for the correlator, the number of flops in the computation is the
