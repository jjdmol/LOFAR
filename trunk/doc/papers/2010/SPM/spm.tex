...
\hline
cache sharing level       & single thread                  & all threads in a \\
                          & (SPE)                          & multiprocessor \\
\hline
...
Although the BG/P kan keep the same number of values in register as the 
...
levels~\cite{amd-manual}.  The low-level programming model is called the ``Compute
