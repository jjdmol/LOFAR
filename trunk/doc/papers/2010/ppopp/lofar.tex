...
from the LOFAR stations in the field to the Blue Gene/P, the transfer
...
the SKA, will likely use even fewer bits per sample.
...
Up to this point, processing chunks from different stations can be done
independently, but from here on, the data from all stations are required.
Therefore, the asynchronous exchange ends here.
...
@@@ let op, echte data!
software wordt dagelijks gebruikt voor observaties with the currently available stations
