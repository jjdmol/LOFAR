...
combine data using customized hardware, we process the data in \emph{software}. 
...
The software also supports multiple simultaneous observations, even of different
types.
...
% @@@ TODO, change back to ``we''
In earlier work, Romein et al.~\cite{Romein:06}, presented an initial prototype
