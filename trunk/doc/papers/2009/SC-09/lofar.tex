...
This dramatically increases flexibility and significantly reduces costs, but
the high processing and bandwidth requirements compel the use of a
supercomputer.
The antenna signals are centrally combined, filtered, and beam-formed or
correlated by a 10,880-core Blue Gene/P.
...
This allows us to use only half the amount of planned resources, \emph{and\/}
process 50\% more telescope data, significantly increasing the performance
