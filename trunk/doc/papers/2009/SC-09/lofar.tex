...
use customized hardware, we process the real-time data in \emph{software}. 
This dramatically increases flexibility, but the high
...
beamformed or correlated by a 10,880-core IBM Blue Gene/P.

To meet the real-time requirements, the application is highly optimized.
We reach exceptionally high computational performance:
up to 96\% of the theoretical floating-point peak.
Also, a major redesign of the network system software was
required to obtain enough internal I/O bandwidth.
Our solutions greatly enhance flexibility, at significantly lower costs.
\end{abstract}
