...
Deller et al.~\cite{Deller:07} have developed the DiFX distributed software correlator, which
is deployed on a cluster of PCs. Due to their use of commodity hardware, they are severely limited
in the data rates they can process at real time.
...
(JIVE), but is not yet capable of processing telescope data in real time.
