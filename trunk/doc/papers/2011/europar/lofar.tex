...
Figure \ref{fig:stations-beams} shows the maximum number of beams that can be created in each of the three modes: Complex Voltages, Stokes IQUV, and Stokes I. In the Stokes I mode, which is several
...
\caption{The time spent in the processing steps. I/IQUV = Stokes variant, i = integration factor, s = stations, b = beams}
\end{figure}
