...
#
dropdb -h dop50 -U postgres overeem
createdb -h dop50 -U postgres overeem

echo "creating new tables"
psql -f create_OTDB.sql -h dop50 -U postgres overeem 2>&1 | grep ERROR | grep -v "does not exist"
