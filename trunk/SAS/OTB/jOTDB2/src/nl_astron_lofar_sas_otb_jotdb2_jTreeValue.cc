//#  jTreeValue.cc: Manages the connection with the OTDB database.
//#
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_nl_astron_lofar_sas_otb_jotdb2_jTreeValue_initTreeValue(JNIEnv *, jobject) {
 ...
 */
JNIEXPORT jobject JNICALL Java_nl_astron_lofar_sas_otb_jotdb2_jTreeValue_searchInPeriod(JNIEnv *env, jobject, jint aTreeID, jint topNode, jint depth, jstring beginDate, jstring endDate, jboolean mostRecentOnly) {
  // get treevalues
