...
#ifndef CEPFRAME_CORBA_TRANSPORT_OUT_H
#define CEPFRAME_CORBA_TRANSPORT_OUT_H
...
#include "CEPFrame/Corba/CorbaTransportInterface_s.hh"
#include "CEPFrame/Corba/MTCircularBuffer.h"
