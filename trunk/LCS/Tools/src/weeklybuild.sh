...
autoconf_share/rub -system -noupdate -release=main -confopt "--prefix=$INSTALLDIR/gnu_debug" -build "gnu_debug" -checktool "/usr/local/bin/valgrind --tool=memcheck --num-callers=50 --leak-check=yes --track-fds=yes --log-file=$INSTALLDIR/gnu_valgrind/[PROGNAME].valgrind" Appl LCS CEP MAC/{Test/Suite,GCF/GCFCommon,GCF/TM,APL/RTCCommon,APL/PAC/BeamServer,APL/PAC/BS_Protocol,APL/PAC/CAL_Protocol,APL/PAC/CalServer,APL/PIC/RSPDriver,APL/PIC/RSP_Protocol} Demo >& $BUILDROOT/lofar17-week`date +%g%W`-gnu_valgrind.log

# GNU_DEBUG_DISTCHECK
#
#autoconf_share/rub -system -noupdate -release=main -confopt "--prefix=$INSTALLDIR/gnu_debug" -build "gnu_debug" -distcheck Appl LCS CEP MAC/{Test/Suite,GCF/GCFCommon,GCF/TM,APL/RTCCommon,APL/PAC/BeamServer,APL/PAC/BS_Protocol,APL/PAC/CAL_Protocol,APL/PAC/CalServer,APL/PIC/RSPDriver,APL/PIC/RSP_Protocol} Demo >& $BUILDROOT/lofar17-week`date +%g%W`-gnu_distcheck.log

# GNU_OPT Build
#
source $INSTALLDIR/gnu_opt/lofarinit.sh
rm -rf $INSTALLDIR/gnu_opt/*
autoconf_share/rub -system -noupdate -release=main -confopt "--prefix=$INSTALLDIR/gnu_opt" -build "gnu_opt" Appl LCS CEP MAC/{Test/Suite,GCF/GCFCommon,GCF/TM,APL/RTCCommon,APL/PAC/BeamServer,APL/PAC/BS_Protocol,APL/PAC/CAL_Protocol,APL/PAC/CalServer,APL/PIC/RSPDriver,APL/PIC/RSP_Protocol} Demo >& $BUILDROOT/lofar17-week`date +%g%W`-gnu_opt.log

# GNU_NOLOG4CPLUS
#
source $INSTALLDIR/gnunew_nolog4cplus/lofarinit.sh
rm -rf $INSTALLDIR/gnunew_nolog4cplus/*
autoconf_share/rub -system -noupdate -release=main -confopt "--prefix=$INSTALLDIR/gnunew_nolog4cplus" -build "gnunew_nolog4cplus" Appl LCS CEP Demo Timba>& $BUILDROOT/lofar17-week`date +%g%W`-gnunew_nolog4cplus.log

# GNUNEW_DEBUG
#
source $INSTALLDIR/gnunew_debug/lofarinit.sh
rm -rf $INSTALLDIR/gnunew_debug/*
autoconf_share/rub -system -noupdate -release=main -confopt "--prefix=$INSTALLDIR/gnunew_debug" -build "gnunew_debug" Appl LCS CEP MAC/{Test/Suite,GCF/GCFCommon,GCF/TM,APL/RTCCommon,APL/PAC/BeamServer,APL/PAC/BS_Protocol,APL/PAC/CAL_Protocol,APL/PAC/CalServer,APL/PIC/RSPDriver,APL/PIC/RSP_Protocol} Demo >& $BUILDROOT/lofar17-week`date +%g%W`-gnunew.log

# GNU_MPICH
#
source $INSTALLDIR/gnu_mpich/lofarinit.sh
rm -rf $INSTALLDIR/gnu_mpich/*
autoconf_share/rub -system -noupdate -release=main -confopt "--prefix=$INSTALLDIR/gnu_mpich" -build "gnu_mpich" LCS/Common LCS/databases/PL LCS/Transport LCS/databases/TransportPL LCS/ACC CEP/tinyCEP CEP/CEPFrame >& $BUILDROOT/lofar17-week`date +%g%W`-gnu_mpich.log

# GNU_FAKEBGL
#
source $INSTALLDIR/gnu_fakebgl/lofarinit.sh
rm -rf $INSTALLDIR/gnu_fakebgl/*
autoconf_share/rub -system -noupdate -release=main -confopt "--prefix=$INSTALLDIR/gnu_fakebgl" -build "gnu_fakebgl" LCS/Common LCS/Transport CEP/tinyCEP >& $BUILDROOT/lofar17-week`date +%g%W`-gnu_fakebgl.log

# ICC_DEBUG
#
#source $INSTALLDIR/icc_debug/lofarinit.sh
#rm -rf $INSTALLDIR/icc_debug/*
#autoconf_share/rub -system -noupdate -release=main -confopt "--prefix=$INSTALLDIR/icc_debug" -build "icc_debug" Appl LCS CEP Demo >& $BUILDROOT/lofar17-week`date +%g%W`-iccdebug.log
...
export DOXYGEN="/usr/local/doxygen/bin/doxygen";make docxx  PACKAGES="LCS CEP MAC SAS Timba  Demo" >& $BUILDROOT/lofar17-week`date +%g%W`-docxx.log
...
cd $INSTALLDIR/docxxhtml;./installdox -l doxygen.tag@http://www.lofar.org/software/docxxhtml/doxygen
