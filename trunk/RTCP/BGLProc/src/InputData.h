#ifndef LOFAR_BGLPROC_INPUT_DATA_H
#define LOFAR_BGLPROC_INPUT_DATA_H
...
template <typename SAMPLE_TYPE> class InputData
{
  ...
  public:
    boost::multi_array_ref<SAMPLE_TYPE, 3> samples; //[outputPsets.size()][itsPS->nrSamplesToBGLProc()][NR_POLARIZATIONS]
