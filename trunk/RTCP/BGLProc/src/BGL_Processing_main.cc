...
#include <BGLProc/LocationInfo.h>
#include <BGLProc/BGL_Processing.h>
#include <BGLProc/Package__Version.h>
...
int main(int argc, char **argv)
{
  ...
  try {
    ...
    if (locationInfo.rank() == 0) {
      ...
      Version::show<BGLProcVersion> (std::cout, "BGLProc", type);
    }
