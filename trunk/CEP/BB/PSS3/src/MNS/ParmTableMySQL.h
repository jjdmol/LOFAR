...
class ParmTableMySQL : public ParmTableRep
{
public:
...
private:
  ...
  inline MeqMatrix getMeqMatrix(MYSQL_ROW* resRow, int column);
  inline double getDouble(MYSQL_ROW* resRow, int column);
  inline MeqDomain getDomain(MYSQL_ROW* resRow, int column);
  ...
  inline MeqPolc readPolcNoDomainQRes(MYSQL_ROW* resRow, int column);

  inline string getDomainColumns();
  inline MeqDomain readDomainQRes(MYSQL_ROW* resRow, int column);
  
  inline string getMeqParmNoPolcColumns();
  inline MeqParmHolder readMeqParmNoPolcQRes(MYSQL_ROW* resRow, int column);
