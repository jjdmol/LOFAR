...
echo "  Starting solve ..."
time ./tBBS2 tBBS2.test1 $1 >& test1.out
...
echo "  Starting solve ..."
time ./tBBS2 tBBS2.test2 $1 >& test2.out
...
echo "  Starting solve ..."
time ./tBBS2 tBBS2.test3 $1 >& test3.out
...
echo "  Starting solve ..."
time ./tBBS2 tBBS2.test4 $1 >& test4.out
...
echo "  Starting solve ..."
time ./tBBS2 tBBS2.test5 $1 >& test5.out
...
echo "  Starting solve ..."
time ./tBBS2 tBBS2.test6 $1 >& test6.out
...
echo "  Starting solve ..."
time ./tBBS2 tBBS2.test7 $1 >& test7.out
...
echo "  Starting solve ..."
time ./tBBS2 tBBS2.test8 $1 >& test8.out
...
echo "  Starting solve ..."
time ./tBBS2 tBBS2.test9 $1 >& test9.out
...
echo "  Starting solve ..."
time ./tBBS2 tBBS2.test10 $1 >& test10.out
...
echo "  Starting solve ..."
time ./tBBS2 tBBS2.test11 $1 >& test11.out
...
echo "  Starting solve ..."
time ./tBBS2 tBBS2.test12 $1 >& test12.out
...
echo "  Starting solve ..."
time ./tBBS2 tBBS2.test13 $1 >& test13.out
