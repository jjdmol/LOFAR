...
%
%\renewcommand{\theAuthor}  {D.\ Hoogland \and\ K.\ van der Schaaf}
...
\renewcommand{\theDocNR}   {LOFAR-ASTRON-MEM-097}
\renewcommand{\theFile}    {http://dop49.nfra.nl/ $\tilde{ }$ daan/BlackBoard/bb-implementation.pdf}
%
% Define the title of the document
%

\renewcommand{\theTitle}
{design considerations for a blackboard application framework}
