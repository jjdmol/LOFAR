...
\begin{document}
  ...
  \begin{abstract}
    ...
    \em{The implementation details of a blackboard\index{blackboard} application
    ...
    structure of a ``BlackBoard'' \index{blackboard!BlackBoard}. The design and implementation details
...
%  \listoftables
  ...
  \label{sec:introduction}\hypertarget{sec:introduction}{}
    ...
    \label{subsec:purpose}\hypertarget{subsec:purpose}{}
      ...
      \index{blackboard!Blackboard architectural pattern} architectural pattern
...
\end{verbatim}
      ...
      \subsubsection{dynamic model}
        ...
        \begin{figure}{510pt}
          \includegraphics[]{../figures/overview2.eps}
        ...
        \begin{figure}{296pt}
          \includegraphics[]{../figures/startOfExecutable.eps}
    ...
    \subsection{protocol semantics}
      ...
      External knowledge source\index{blackboard!knowledge source}s, that are being embedded in a
      ...
      \subsubsection{the BlackBoard API}
        ...
        ``area''\index{blackboard!area}s on the blackboard. These are identified, and so are
        entries in these tables, or ``item''\index{blackboard!item}s on these areas. Also
        ...
        definition of a knowledge source\index{blackboard!knowledge source}. If no explicit definition of
        ...
        \paragraph{Selfcal's entry area's} will have to supply some
          ...
          A ``ThreadController'' \index{BlackBoard!ThreadController} will have to know whether it needs to issue new
          ...
          A ``ThreadWatcher'' \index{BlackBoard!ThreadWatcher} is
          ...
          solution thread\index{solution thread}s can run
          ...
          The ``ThreadWatcher'' \index{BlackBoard!ThreadWatcher} gets
          the assignment to watch a certain solution
          thread\index{solution thread}. It will then start
    ...
    \subsection{deployment}
      ...
      \begin{figure}{399pt}
        \includegraphics[]{../figures/deployment-hierarchy.eps}
    ...
    \subsection{code organisation}
      ...
      \begin{figure}{288pt}
        \includegraphics[]{../figures/components.eps}
  ...
  \label{sec:distributed-hierarchical-blackboard}\hypertarget{sec:distributed-hierarchical-blackboard}{}%
    ...
    \label{subsec:components}\hypertarget{subsec:components}{}
      ...
      \label{subsubsec:controllers}\hypertarget{subsubsec:controllers}{}
        ...
        \begin{figure}{430pt}
          \includegraphics[]{../figures/control-hierarchy2.eps}
...
%      \hypertarget{fig:strategy-distribution}{}
%      \caption{A possible control hierarchy snapshot during interpretation.\label{fig:strategy-distribution}}
%    \end{figure}
...
% LocalWords:  blackboard Blackboard BlackBoard LOFAR API ThreadController Hoogland SQL ASTRON Schaaf
% LocalWords:  ThreadWatcher der Kjeld Daan selfcal deploymentdata
% LocalWords:  WorkerWrapper selfcalMapped startOfExecutable localGlobalCommit
