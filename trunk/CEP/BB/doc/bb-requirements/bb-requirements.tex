...
\begin{document}
  ...
  \begin{abstract}
    ...
    \em{The use of the Blackboard architectural pattern,
      in the LOFAR Central Processor,
      for the selfcal control system}
  ...
  \end{figure}
    ...
    \label{subsec:pattern-components}
      ...
      In \hyperlink{fig:overview}{[Figure \ref{fig:overview}]}, the
      communication from the TreadController or the ThreadWatcher to
      the WorkerProxy and back is all done by means of the BlackBoard.
    ...
    \label{sec:demo-usecase}
      ...
      \begin{figure}
        ...
        \caption{the basic use-case for the self-calibration application\label{fig:demo-usecase}}
      \end{figure}
...
\end{Verbatim}
        ...
        \hyperlink{stub-code}{Appendix {\ref*{app:stub-code}}}
