...
\renewcommand{\theDocNR}   {LOFAR-ASTRON-MEM-096}
\renewcommand{\theFile}    {http://dop49.nfra.nl/ $\tilde{ }$ daan/BlackBoard/bb-requirements.pdf}
%
% Define the title of the document
%

\renewcommand{\theTitle}
{BlackBoard BreadBoard, a demo framework for imaging applications}
