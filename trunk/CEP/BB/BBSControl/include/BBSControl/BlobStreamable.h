...
#ifndef LOFAR_BBSCONTROL_BLOBSTREAMABLE_H
#define LOFAR_BBSCONTROL_BLOBSTREAMABLE_H
...
namespace LOFAR
{
  ...
  namespace BBS
  {
    ...
    protected:
      // Factory method. Needs to be refactored into a separate factory class.
      static BlobStreamable* create(const string& typeName);
