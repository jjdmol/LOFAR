...
class Socket 
{
  ...
  public:
    ...
    //##ModelId=3DB936D00067
      ...
      //##                0 when connect still in progress, try again
      //##               <0 failure (returns error code)
      //## So, if you get a zero, keep calling connect until you get a
      //## definite success or failure (in between, you can sleep for .1 
      //## sec or so, or do a select() on the fd).
