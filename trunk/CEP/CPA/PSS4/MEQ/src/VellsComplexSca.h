//# VellsComplexSca.h: Temporary vells for Mns
//#
//# Copyright (C) 2002
...
#ifndef MEQ_VELLSCOMPLEXSCA_H
#define MEQ_VELLSCOMPLEXSCA_H
...
public:
  VellsComplexSca (complex<double> value)
    : VellsRep   (1, 1),
      itsValue   (value),
