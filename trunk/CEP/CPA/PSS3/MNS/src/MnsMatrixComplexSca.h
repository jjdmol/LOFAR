//# MnsMatrixComplexSca.h: Temporary matrix for Mns
//#
//# Copyright (C) 2002
...
#if !defined(MNS_MNSMATRIXCOMPLEXSCA_H)
#define MNS_MNSMATRIXCOMPLEXSCA_H
...
class MnsMatrixComplexSca : public MnsMatrixRep
{
...
public:
  MnsMatrixComplexSca (complex<double> value)
    : MnsMatrixRep(1, 1, sizeof(complex<double>)), itsValue (value) {}

  virtual ~MnsMatrixComplexSca();
