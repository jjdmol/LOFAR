//# tMnsMatrix.cc: Test program for MnsMatrix classes
//# Copyright (C) 2002
...
void showDouble (const MnsMatrixTmp& v)
{
    cout << v << endl;
}
void showDComplex (const MnsMatrixTmp& v)
{
    cout << v << endl;
}
