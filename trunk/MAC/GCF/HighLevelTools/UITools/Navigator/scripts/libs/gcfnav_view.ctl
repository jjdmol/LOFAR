...
navViewControlDisplayStatus(string dp1, int statusNumber)
{
  ...
  strreplace(elementName, ".", "");
  if(statusNumber==0)
    textToDisplay = "NO_ERROR";
  else if(statusNumber==1)
    textToDisplay = "ERROR_UNSPECIFIED";
  else if(statusNumber==2)
    textToDisplay = "ERROR_VI_NOT_FOUND";
  else if(statusNumber==3)
    textToDisplay = "ERROR_PARAMETERNOTFOUND";
  else if(statusNumber==4)
    textToDisplay = "ERROR_INCORRECT_NUMBER_OF_PARAMETERS";
  else if(statusNumber==5)
    textToDisplay = "ERROR_UNKNOWN_COMMAND";
  else if(statusNumber==6)
    textToDisplay = "ERROR_DISABLED";
  else if(statusNumber==7)
    textToDisplay = "ERROR_LOW_QUALITY";
  else if(statusNumber==8)
    textToDisplay = "ERROR_TIMING_FAILURE";
  else if(statusNumber==9)
    textToDisplay = "ERROR_WRONG_VERSION";
  else if(statusNumber==10)
    textToDisplay = "ERROR_UNSUPPORTED_LD";
  else if(statusNumber==11)
    textToDisplay = "ERROR_LD_NOT_FOUND";
  else if(statusNumber==12)
    textToDisplay = "ERROR_WRONG_STATE";
  else if(statusNumber==13)
    textToDisplay = "ERROR_SHUTDOWN";
  else if(statusNumber==14)
    textToDisplay = "ERROR_ALREADY_EXISTS";
  else
