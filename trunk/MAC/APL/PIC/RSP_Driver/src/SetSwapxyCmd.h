...
//#
//#  $Id: SetSwapxyCmd.h 15023 2010-02-18 15:24:31Z donker $

#ifndef SETSWAPXYCMD_H_
#define SETSWAPXYCMD_H_
...
namespace LOFAR {
  namespace RSP {
    ...
    class SetSwapXYCmd : public Command
    {
    public:
      /**
       * Constructors for a SetLatencyCmd object.
       */
      SetSwapXYCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for SetVersionsCmd. */
      virtual ~SetSwapXYCmd();
    ...
    private:
      ...
      RSPSetswapxyEvent* m_event;
    };
  };
};

#endif /* SETSWAPXYCMD_H_ */
