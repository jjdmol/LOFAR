...
#define EPA_MEP(oper, dstid, pid, regid)		\
{							\
    EPA_Protocol::MEPHeader::oper,        /* type */	\
    0,                                    /* ffi */	\
    0,                                    /* seqnr */	\
    {							\
	  EPA_Protocol::MEPHeader::dstid, /* dstid */	\
	  EPA_Protocol::MEPHeader::pid,   /* pid */	\
	  EPA_Protocol::MEPHeader::regid, /* regid */	\
          EPA_Protocol::MEPHeader::PAGE_INACTIVE, /* pageid */	\
    },							\
    0,                                   /* offset */	\
    0,                                   /* size */	\
}
...
#define MEP_RSPSTATUS(hdr, oper)            (hdr).set(oper,       CTX(DST_RSP), CTX(STATUS), CTX(RSPSTATUS), CTX(RSPSTATUS_SIZE))
