//#  ArrayOperations.h: handles all events for a task.
//#
...
namespace AAO // :-)
{
  ...
  class ArrayOperations : public APLCommon::LogicalDevice
  {
    public:
      ...
      explicit ArrayOperations(const string& taskName, const string& parameterFile, GCF::TM::GCFTask* pStartDaemon);
    ...
    protected:
      ...
      ArrayOperations(const ArrayOperations&);
      // protected assignment operator
      ArrayOperations& operator=(const ArrayOperations&);
