//#  ArrayReceptorGroup.h: handles all events for a task.
//#
...
#ifndef ArrayReceptorGroup_H
#define ArrayReceptorGroup_H
...
namespace AAR
{
  ...
  class ArrayReceptorGroup : public APLCommon::LogicalDevice
  {
    public:
      ...
      explicit ArrayReceptorGroup(const string& taskName, const string& parameterFile, GCF::TM::GCFTask* pStartDaemon);
      virtual ~ArrayReceptorGroup();

    protected:
      // protected default constructor
      ArrayReceptorGroup();
      // protected copy constructor
      ArrayReceptorGroup(const ArrayReceptorGroup&);
      // protected assignment operator
      ArrayReceptorGroup& operator=(const ArrayReceptorGroup&);
