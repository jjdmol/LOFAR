...
if test "$1" = "wrapper"; then
  ...
  REMOTECMD="echo 'wrapper started'"
...
if test "$1" = "storage"; then
  ...
  NAME=Storage
  HOST=dop66.astron.nl
  REMOTECMD="echo 'storage started'"
...
if test "$1" = "postproc"; then
  ...
  NAME=PostProcessing
  HOST=dop66.astron.nl
  REMOTECMD="echo 'postproc started'"
