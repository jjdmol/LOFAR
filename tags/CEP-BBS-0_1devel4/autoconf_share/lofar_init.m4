...
[
  ...
  *_*)
  ...
  # the body of the fillVersion function.
...
namespace LOFAR {
  bool ${PACKAGE}Version::fillVersion (const std::string& mainVersion,
				       std::vector<std::string>& v)
  {
    // Add version of this package.
    bool sameVers = Version::fillVersion ("${PACKAGE}",
					  getVersion(), getVersionSuffix(),
					  mainVersion, v);
    // Add version of packages being used.
EOF
