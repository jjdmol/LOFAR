...
class HTTPConnection:
    ...
    def sendbinary(self, fp, blocksize=8192):
    ...
    def _send_request(self, method, url, body, headers):
        ...
        if body:
            if isinstance(body, file):
                s = os.stat(body.name) ## how big is this file?
                self.putheader('Content-Length', str(s.st_size))
            else:
