//#  ABSEPATest.h: class definition for the Virtual Telescope test stub.
//#
...
#ifndef ABSEPATEST_H_
#define ABSEPATEST_H_
...
namespace ABS
{
    class EPATest : public GCFTask, public Test
    {
    public:
	/**
	 * The constructor of the EPATest task.
