...
#define SCOPE_PIC_Rack2_SubRack1_Board1_AP1_RCU1              "PIC_Rack2_SubRack1_Board1_AP1_RCU1"
#define SCOPE_PIC_Rack3_SubRack1_Board1_AP1_RCU1              "PIC_Rack3_SubRack1_Board1_AP1_RCU1"
...
std::vector<TTranTarget>            g_testSequence;
std::vector<TTranTarget>::iterator  g_testSequenceIt;
...
AVTTestMAC2Task::AVTTestMAC2Task() :
  ...
  m_propertysetAP2RCU1(SCOPE_PIC_Rack2_SubRack1_Board1_AP1_RCU1,TYPE_LCU_PIC_RCU.c_str(),&m_answer),
  m_propertysetAP3RCU1(SCOPE_PIC_Rack3_SubRack1_Board1_AP1_RCU1,TYPE_LCU_PIC_RCU.c_str(),&m_answer),
  ...
  m_nrOfPropsets(0)
{
  ...
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_4_1,1,"3_2_4_1: Start VT, all antennas in maintenance");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_4_2,2,"3_2_4_2: Start VT, too many antennas in maintenance");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_4_3,3,"3_2_4_3: Start VT, no antennas in maintenance");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_4_4,4,"3_2_4_3: Start VT, no antennas in maintenance");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_4_5,5,"3_2_4_5: Change antenna parameter using the first VT");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_4_6,6,"3_2_4_5: Change antenna parameter using the first VT");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_4_7,7,"3_2_4_7: Abort the first VT");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_4_8,8,"3_2_4_8: Change antenna parameter using the second VT");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_5_1,9,"3_2_5_2: Schedule the same VT at non-overlapping timespans");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_5_2,10,"3_2_5_3: Schedule the same VT at overlapping timespans");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_5_3,11,"3_2_5_4: Cancel a VT Schedule");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_5_4,12,"3_2_5_5: Schedule two VT's at the same time");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_5_5,13,"3_2_6_1: Display subband statistics of a running VT");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_6_1,14,"3_2_7_1: Antenna defect, no VT uses this antenna");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_7_1,15,"3_2_7_2: 1 antenna defect, VT keeps on running");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_7_2,16,"3_2_7_3: more antennas defect, VT stops");
  ADDTRANTARGET(g_testSequence,AVTTestMAC2Task::test_3_2_7_3,17,"3_2_7_3: more antennas defect, VT stops");
  g_testSequenceIt = g_testSequence.begin();
...
GCFEvent::TResult AVTTestMAC2Task::initial(GCFEvent& event, GCFPortInterface& /*port*/)
{
  ...
  switch (event.signal)
  {
    ...
    case F_ENTRY:
    {
      ...
      // load ext properties
      m_nrOfPropsets=0;
      m_propertysetLDS.load();
      m_nrOfPropsets++;
      m_propertysetBoard1Maintenance.load();
      m_nrOfPropsets++;
      m_propertysetAP1RCU1Maintenance.load();
      m_nrOfPropsets++;
      m_propertysetAP1RCU2Maintenance.load();
      m_nrOfPropsets++;
      m_propertysetAP1RCU1.load();
      m_nrOfPropsets++;
      m_propertysetAP2RCU1.load();
      m_nrOfPropsets++;
      m_propertysetAP3RCU1.load();
      m_nrOfPropsets++;
      break;
    }  
    ...
    case F_EXTPS_LOADED:
    {
      ...
      if(m_propsetLoadedCounter==m_nrOfPropsets)
      {
	      NEXTTEST(g_testSequenceIt);
      }
      break;
    }  
    ...
    case F_VCHANGEMSG:
    {
      ...
      if(strstr(pPropAnswer->pPropName,SCOPE_PIC_Rack1_Subrack1_Board1_Maintenance)!=0)
      {
        ...
        else
        {
          ...
          m_timerPort.setTimer(1.0); // wait a while until the LDS has enabled the VT1 property set
        }
      }
      else if(strstr(pPropAnswer->pPropName,SCOPE_PAC_VT1)!=0)
      {
        ...
        bool releasing = status.getValue() == string("Releasing");
        if(releasing)
        {
          TESTC(releasing);
          NEXTTEST(g_testSequenceIt);
...
GCFEvent::TResult AVTTestMAC2Task::test_3_2_4_2(GCFEvent& event, GCFPortInterface& p)
{
  ...
  switch (event.signal)
  {
    ...
    case F_ENTRY:
    {
      ...
      GCFPVUnsigned inMaintenance(1);
      if(!TESTC(GCF_NO_ERROR==m_propertysetBoard1Maintenance.setValue(PROPNAME_STATUS,outMaintenance) && 
                GCF_NO_ERROR==m_propertysetAP1RCU1Maintenance.setValue(PROPNAME_STATUS,inMaintenance) &&
    ...
    case F_VCHANGEMSG:
    {
         ...
         strstr(pPropAnswer->pPropName,SCOPE_PIC_Rack1_SubRack1_Board1_AP1_RCU2_Maintenance)!=0)
      {
        ...
        if(!TESTC( (strstr(pPropAnswer->pPropName,SCOPE_PIC_Rack1_Subrack1_Board1_Maintenance)!=0 && inMaintenance.getValue()==0) ||
                   (strstr(pPropAnswer->pPropName,SCOPE_PIC_Rack1_SubRack1_Board1_AP1_RCU1_Maintenance)!=0 && inMaintenance.getValue()!=0) ||
                   (strstr(pPropAnswer->pPropName,SCOPE_PIC_Rack1_SubRack1_Board1_AP1_RCU2_Maintenance)!=0 && inMaintenance.getValue()!=0) ) )
        {
          NEXTTEST(g_testSequenceIt);
        }
        else if(m_maintenanceChangedCounter==3)
        {
          // SCHEDULE <scheduleid>,VT,<vt_name>,<bf_name>,<srg_name>,<starttime>,<stoptime>,
          //          <frequency>,<subbands>,<directiontype>,<angle1>,<angle2>
...
GCFEvent::TResult AVTTestMAC2Task::test_3_2_4_3(GCFEvent& event, GCFPortInterface& p)
{
  ...
  switch (event.signal)
  {
    ...
    case F_ENTRY:
    {
      ...
      m_propertysetAP1RCU2Maintenance.subscribeProp(PROPNAME_STATUS);
      GCFPVUnsigned outMaintenance(0);
      if(!TESTC(GCF_NO_ERROR==m_propertysetAP1RCU1Maintenance.setValue(PROPNAME_STATUS,outMaintenance) &&
                GCF_NO_ERROR==m_propertysetAP1RCU2Maintenance.setValue(PROPNAME_STATUS,outMaintenance)))
      {
        NEXTTEST(g_testSequenceIt);
      }
      break;
    ...
    case F_VCHANGEMSG:
    {
      ...
      else if(strstr(pPropAnswer->pPropName,SCOPE_PAC_VT1)!=0)
      {
        ...
        status.copy(*pPropAnswer->pValue);
        LOG_INFO(formatString("Value of '%s': %s",pPropAnswer->pPropName,status.getValue().c_str()));
        bool active = ( status.getValue() == string("Active") );
        if(active)
        {
          TESTC(active);
          NEXTTEST(g_testSequenceIt);
...
GCFEvent::TResult AVTTestMAC2Task::test_3_2_4_4(GCFEvent& event, GCFPortInterface& p)
{
  ...
  switch (event.signal)
  {
    ...
    case F_ENTRY:
    {
      ...
      m_timerPort.setTimer(1.0); // wait a while until the LDS has enabled the VT2 property set
  ...
  switch (event.signal)
  {
    ...
    case F_VCHANGEMSG:
    {
      ...
      if(strstr(pPropAnswer->pPropName,SCOPE_PAC_LogicalDeviceScheduler)!=0)
      {
        ...
        status.copy(*pPropAnswer->pValue);
        LOG_INFO(formatString("Value of '%s': %s",pPropAnswer->pPropName,status.getValue().c_str()));
        TESTC(status.getValue() == string("Error") && "This fails because this feature is not implemented yet"); // Error is good
        NEXTTEST(g_testSequenceIt);
      }
      break;
    }
...
GCFEvent::TResult AVTTestMAC2Task::test_3_2_6_1(GCFEvent& event, GCFPortInterface& /*p*/)
{
  ...
  switch (event.signal)
  {
    ...
    case F_ENTRY:
    {
      ...
      TESTC(false && "This is tested in the RegisterAccess application" );
      NEXTTEST(g_testSequenceIt);
      break;
    }
    default:
...
GCFEvent::TResult AVTTestMAC2Task::test_3_2_7_1(GCFEvent& event, GCFPortInterface& p)
{
  ...
  switch (event.signal)
  {
    ...
    case F_ENTRY:
    {
      ...
      string devices(string("VT3")+string(",")+string("BF3")+string(",")+string("SRG4")+string(","));
      ...
      m_timerPort.setTimer(1.0); // wait a while until the LDS has enabled the VT3 property set
