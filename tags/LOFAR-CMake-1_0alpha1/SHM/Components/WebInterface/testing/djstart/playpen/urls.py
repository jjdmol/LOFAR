...
urlpatterns = patterns('',
                       ...
                       (r'(?P<path>.*css)$','django.views.static.serve', {'document_root': '/home/lofartest/SHM/Components/WebInterface/testing/djstart/playpen'}),
                       (r'(?P<path>.*png)$','django.views.static.serve', {'document_root': '/home/lofartest/SHM/Components/WebInterface/testing/djstart/playpen'}),
