...
jobsdir   = '/tmp/ingest/jobs/'
retrydir  = '/tmp/ingest/jobs_retry/'
faileddir = '/tmp/ingest/log/failed/'
logdir    = '/tmp/ingest/log/'
donedir   = '/tmp/ingest/log/done/'
...
#
LTAurl = 'https://user:pass@lofar-ingest-test.target.rug.nl:19443'  #fill in during build/install
try:
...
## MoM client settings
exportLogin  = 'https://lcs028.control.lofar:8443/export/systemprograms/login.jsp'
exportStatus = 'https://lcs028.control.lofar:8443/export/interface/pipeline/setStatus.do'
exportLogout = 'https://lcs028.control.lofar:8443/export/processLogout.do'
