...
\newfloat{requirement}{ht}{req}[subsection]
...
%  \listoftables
  ...
  \label{sec:introduction}\hypertarget{sec:introduction}{}
    ...
    \label{subsec:purpose}\hypertarget{subsec:purpose}{}
      ...
      \hyperlink{bib:LOFAR-ASTRON-MEM-096}{[HOO03]}.
  ...
  \label{sec:architecture}\hypertarget{sec:architecture}{}
    ...
    \subsection{human perspectives}
      ...
      \subsubsection{management}
        ...
        nodes may it use?'' The application has been given strategy
        scripts to handle on that node that define the internal
        priorities and the distribution within the appointed
        sub-cluster.
      ...
      \subsubsection{system administration}
        ...
        deployed to the different nodes in the system. There are
