...
class OutputAgent : public AppEventAgentBase
{
  public:
    ...
    virtual int put (int type,const ObjRef::Xfer &ref = ObjRef());
    ...
    int putHeader   (const DataRecord::Ref::Xfer &hdr);
    ...
    //##          CLOSED    stream closed
    int putNextTile (const VisTile::Ref::Xfer &tile);
    
    //##ModelId=3EB246C2011E
    int putFooter   (const DataRecord::Ref::Xfer &ftr);
