...
const TypeId TpColumnarTableTile(-1037);          // from /home/oms/LOFAR/CEP/CPA/VisDM/src/ColumnarTableTile.h:10
...
const TypeId TpTableFormat(-1036);                // from /home/oms/LOFAR/CEP/CPA/VisDM/src/TableFormat.h:9
const int TpTableFormat_int = -1036;
class TableFormat;
#endif
#ifndef _defined_id_TpVisCube
#define _defined_id_TpVisCube 1
const TypeId TpVisCube(-1038);                    // from /home/oms/LOFAR/CEP/CPA/VisDM/src/VisCube.h:11
const int TpVisCube_int = -1038;
class VisCube;
#endif
#ifndef _defined_id_TpVisCubeSet
#define _defined_id_TpVisCubeSet 1
const TypeId TpVisCubeSet(-1034);                 // from /home/oms/LOFAR/CEP/CPA/VisDM/src/VisCubeSet.h:12
const int TpVisCubeSet_int = -1034;
class VisCubeSet;
#endif
#ifndef _defined_id_TpVisTile
#define _defined_id_TpVisTile 1
const TypeId TpVisTile(-1035);                    // from /home/oms/LOFAR/CEP/CPA/VisDM/src/VisTile.h:26
