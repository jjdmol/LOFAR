/*
//  AppControllerParse.y: Scanner for small control programs
//
//  Copyright (C) 2001
...
%{
int AppControllerTokenizelex (YYSTYPE*);
#define AppControllerParselex AppControllerTokenizelex
%}
...
defcom:    DEFCOMMAND parameters ENDCOMM {
               AppControllerParse::execute (*$1, *$2);
	       delete $1;
	       delete $2;
           }
       |   DEFCOMMAND ENDCOMM {
               AppControllerParse::execute (*$1, KeyValueMap());
	       delete $1;
           }
       ;
