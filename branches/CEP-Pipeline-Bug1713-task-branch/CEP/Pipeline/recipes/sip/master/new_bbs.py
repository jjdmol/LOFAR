...
#def _make_bbs_map(data_mapfile, instrument_mapfile, sky_mapfile):
    #"""
    ...
    #The contents of these files are related. The elements of these lists
    ...
    #bbs_map[0] = ('locus001',
        #('/data/L29697/L29697_SAP000_SB000_uv.MS',
         #'/data/scratch/pipeline/L29697/L29697_SAP000_SB000_uv.MS.instrument',
         #'/data/scratch/pipeline/L29697/L29697_SAP000_SB000_uv.MS.sky')
    #)
    #"""
    #data_map = parameterset(data_mapfile)
    #instrument_map = parameterset(instrument_mapfile)
    #sky_map = parameterset(sky_mapfile)
    #bbs_map = []
    ...
    **Arguments**
    ...
    inputs = {
        ...
        'gvds_file': ingredient.FileField(
            '--gvds-file',
            help="Full path to the GVDS file generated by vdsmaker"
        ),
        ...
        'skip_makesourcedb': ingredient.BoolField(
            '--skip-makesourcedb',
            help="Skip generation of initial sky model (souredb)",
            default=True
        ),
        'skip_makeparmdb': ingredient.BoolField(
            '--skip-makeparmdb',
            help="Skip generation of initial instrument model (parmdb)",
            default=True
        )
    }
    ...
    def go(self):
        ...
        bbs_parset = utilities.patch_parset(
            ...
            {
                'Observation': self.inputs['gvds_file'],
