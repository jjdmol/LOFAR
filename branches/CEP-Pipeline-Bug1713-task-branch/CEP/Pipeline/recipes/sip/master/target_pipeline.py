...
class target_pipeline(control):
    ...
    # let the user specify the path to the instrument- and skymodel mapfiles.
    inputs = {
        ...
        'sub_array_pointing': ingredient.IntField(
            '--sub-array-pointing',
            help="Sub-Array Pointing (zero-based number)"
        )
    }
    ...
    def pipeline_logic(self):
        ...
        data_mapfile = self.run_task(
            ...
            observation_sap=self.inputs['sub_array_pointing']
#            parset=self.inputs['args'][0]
        ...
        self.run_task(
            ...
            sky_mapfile=self.inputs['sky_mapfile'])
