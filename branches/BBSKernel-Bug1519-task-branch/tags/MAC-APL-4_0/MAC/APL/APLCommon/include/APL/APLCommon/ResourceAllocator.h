...
class ResourceAllocator
{
  ...
  public: // member functions
    bool claimSO(ResourceAllocator::LogicalDevicePtr ld, uint16 priority, double samplingFrequency);
    void releaseSO(ResourceAllocator::LogicalDevicePtr ld);
    void logSOallocation() const;
  
    bool claimSRG(ResourceAllocator::LogicalDevicePtr ld, uint16 priority, 
        TRcuSubset rcuSubset, int16 nyquistZone, uint8 rcuControl);
  ...
  private: // data members
    ...
    struct TSOAllocation : public TAllocation
    {
      ...
      TSOAllocation( LogicalDevicePtr _ld, uint16 _priority, 
          double _sf) :
    ...
    struct TRcuSettings
    {
      ...
      TRcuSettings() : nyquistZone(0), rcuControl(0) {};
      TRcuSettings(int16 n, uint8 r) : nyquistZone(n), rcuControl(r) {};
    };
