//#  BBSStatus.h: Status that will be returned by the BBS Kernel.
//#
...
#ifndef LOFAR_BBSKERNEL_BBSSTATUS_H
#define LOFAR_BBSKERNEL_BBSSTATUS_H
...
namespace LOFAR
{
  namespace BBS
  {
    ...
    // kernel. This class is most useful in a client/server configuration,
    ...
    ostream& operator<<(ostream& os, const BBSStatus& cs);
