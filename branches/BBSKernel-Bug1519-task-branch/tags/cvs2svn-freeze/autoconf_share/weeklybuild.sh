...
#autoconf_share/rub -system -noupdate -release=main -confopt "--prefix=$INSTALLDIR/icc_debug" -build "icc_debug" Appl LCS CEP Demo > $BUILDROOT/lofar17-week`date +%g%W`-iccdebug.log 2>&1
