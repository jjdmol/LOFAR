...
public:
    ...
    virtual unsigned int shape(unsigned int dim) const = 0;
    virtual unsigned int size() const = 0;

    virtual FlagType &value(unsigned int i1, unsigned int i0) = 0;
    virtual const FlagType &value(unsigned int i1, unsigned int i0) const = 0;
...
public:
    ...
    // The memory layout of a FlagArray is row-major (C-order).
    FlagArrayTemporary(unsigned int l1, unsigned int l0);
    FlagArrayTemporary(unsigned int l1, unsigned int l0,
...
public:
    ...
    // The memory layout of a FlagArray is row-major (C-order).
    FlagArray(unsigned int l1, unsigned int l0);
    FlagArray(unsigned int l1, unsigned int l0, const FlagType &value);
    ...
    FlagType &value(unsigned int i1, unsigned int i0);
    const FlagType &value(unsigned int i1, unsigned int i0) const;
...
public:
    ...
    virtual unsigned int shape(unsigned int dim) const;
    virtual unsigned int size() const;

    virtual FlagType &value(unsigned int i1 = 0, unsigned int i0 = 0);
    virtual const FlagType &value(unsigned int i1 = 0, unsigned int i0 = 0)
        const;
...
{
public:
    FlagArrayImplMatrix(unsigned int l1, unsigned int l0);
    FlagArrayImplMatrix(unsigned int l1, unsigned int l0,
        const FlagType &value);
    ...
    virtual FlagType &value(unsigned int i1, unsigned int i0);
    virtual const FlagType &value(unsigned int i1, unsigned int i0) const;
...
inline FlagArrayTemporary::FlagArrayTemporary(unsigned int l1,
    unsigned int l0)
    :   RefCounted<FlagArrayImpl>(new FlagArrayImplMatrix(l1, l0))
{
}

inline FlagArrayTemporary::FlagArrayTemporary(unsigned int l1,
    unsigned int l0, const FlagType &value)
    :   RefCounted<FlagArrayImpl>(new FlagArrayImplMatrix(l1, l0, value))
{
}
...
inline FlagArray::FlagArray(unsigned int l1, unsigned int l0)
    :   RefCounted<FlagArrayImpl>(new FlagArrayImplMatrix(l1, l0))
{
}
...
inline unsigned int FlagArray::shape(unsigned int dim) const
{
    return instance().shape(dim);
}
...
inline FlagType &FlagArray::value(unsigned int i1, unsigned int i0)
{
    return instance().value(i1, i0);
}

inline const FlagType &FlagArray::value(unsigned int i1, unsigned int i0) const
{
    return instance().value(i1, i0);
}
...
inline FlagArrayImplMatrix::FlagArrayImplMatrix(unsigned int l1,
    unsigned int l0)
    :   FlagArrayImpl(),
        itsSize(l1 * l0),
        itsData(0)
{
    cout << "FlagArrayImplMatrix ctor" << endl;
    itsShape[0] = l0;
    itsShape[1] = l1;
...
inline unsigned int FlagArrayImplMatrix::shape(unsigned int dim) const
{
    DBGASSERT(dim < rank());
    return itsShape[dim];
}
...
inline FlagType &FlagArrayImplMatrix::value(unsigned int i1, unsigned int i0)
{
    DBGASSERT(i1 < shape(1) && i0 < shape(0));
    return itsData[i1 * itsShape[0] + i0];
}

inline const FlagType &FlagArrayImplMatrix::value(unsigned int i1,
