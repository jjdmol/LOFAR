...
//#
//#  $Id: SubArrays.cc 12256 2008-11-26 10:54:14Z overeem $
...
//
// calibrateAll(CalI/F*, writeToFile)
//
void SubArrays::calibrateAll(CalibrationInterface* cal, bool writeToFile)
{
	bool done = false;
