...
{
  public:
    OutputSection(const Parset &, std::vector<signed> &itemList, unsigned outputType, Stream * (*createStream)(unsigned, unsigned));
    ~OutputSection();
  ...
  private:
    ...
    std::vector<signed>         itsItemList; // list of either subbands or beams
