//#  -*- mode: c++ -*-
//#
//#  SetSDOModeCmd.h: Set bits per sample of RSP boards to 16, 8 or 4bit.
//#
...
//#
//#  $Id: SetSDOModeCmd.h 8231 2006-04-28 08:53:22Z donker $

#ifndef SETSDOMODECMD_H_
#define SETSDOMODECMD_H_
...
namespace LOFAR {
  namespace RSP {
    ...
    class SetSDOModeCmd : public Command
    {
    public:
      /**
       * Constructors for a SetSDOModeCmd object.
       */
      SetSDOModeCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for SetSDOModeCmd. */
      virtual ~SetSDOModeCmd();
    ...
    private:
      ...
      RSPSetsdomodeEvent* itsEvent;
    };
  };
};
     
#endif /* SETSDOMODECMD_H_ */
