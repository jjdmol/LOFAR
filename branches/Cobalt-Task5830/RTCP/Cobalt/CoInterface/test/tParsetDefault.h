...
#ifndef LOFAR_COINTERFACE_TPARSETDEFAULT_H
#define LOFAR_COINTERFACE_TPARSETDEFAULT_H
...
LOFAR::Cobalt::Parset makeDefaultTestParset();
LOFAR::Cobalt::Parset makeDefaultTestParset(const std::string& key, const std::string& value);


LOFAR::Cobalt::Parset makeDefaultTestParset() {
  LOFAR::Cobalt::Parset ps;
  ...
  ps.add("Observation.DataProducts.Output_CoherentStokes.locations", "[1*localhost:tParset-data/]");
...
LOFAR::Cobalt::Parset makeDefaultTestParset(const std::string& key, const std::string& value) {
  LOFAR::Cobalt::Parset ps = makeDefaultTestParset();
