 ...
 * Revision       : $Revision: 11405 $
 * Last change by : $Author: jong $
 * Change date	  : $Date: 2013-12-17 16:26:21 +0000 (Tue, 17 Dec 2013) $
 * First creation : 9-feb-2010
 * URL            : $URL: https://svn.astron.nl/ROD/trunk/LOFAR_Cleanup/OTDBtree.cpp $
...
const char * PROCESS_SUBTYPES[NR_PROCESS_SUBTYPES] = {"Averaging Pipeline", "Beam Observation", "Calibration Pipeline",
        "Imaging Pipeline", "Imaging Pipeline MSSS", "Interferometer", "STAND_ALONE", "TBB (piggyback)", "TBB (standalone)", "", "Unknown Process Subtype"};
