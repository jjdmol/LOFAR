 ...
 * URL            : $URL: https://svn.astron.nl/ROD/trunk/LOFAR_Cleanup/astrodate.cpp $
 *
 */
...
//		debugErr("si", "AstroDate::setDay: Error: incorrect day number: ", day);
		return false;
	}
}
...
//#ifdef DEBUG_SCHEDULER
//		std::cerr << "AstroDate::setMonth: Error: incorrect month number: " << month << std::endl;
//#endif
		return false;
	}
}
