//#  InputSection.cc: Workholder for the delay compensation.
//#
//#  Copyright (C) 2006
...
#include <CS1_InputProc/BeamletBuffer.h>
#include <CS1_InputProc/Connector.h>
#include <CS1_InputProc/WH_DelayCompensation.h>
#include <CS1_InputProc/InputThread.h>
#include <CS1_InputProc/ION_Allocator.h>
...
namespace LOFAR 
{
  ...
  namespace CS1 
  {
    INIT_TRACER_CONTEXT(InputSection, LOFARLOGGER_PACKAGE);
