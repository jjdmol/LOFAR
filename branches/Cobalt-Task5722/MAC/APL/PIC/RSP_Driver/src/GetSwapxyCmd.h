...
//#
//#  $Id: GetSwapxyCmd.h 15023 2010-02-18 15:24:31Z donker $

#ifndef GETSWAPXYCMD_H_
#define GETSWAPXYCMD_H_
...
namespace LOFAR {
  namespace RSP {
    ...
    class GetSwapXYCmd : public Command
    {
    public:
      /**
       * Constructors for a GetLatencyCmd object.
       */
      GetSwapXYCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for GetVersionsCmd. */
      virtual ~GetSwapXYCmd();
    ...
    private:
      ...
      RSPGetswapxyEvent* m_event;
    };
  };
};

#endif /* GETSWAPXYCMD_H_ */
