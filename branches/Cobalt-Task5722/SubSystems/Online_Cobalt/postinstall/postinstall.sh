...
#
# Note: if a new version is used, update CMake/variants/variants.cbm001 as well
...
function postinstall_lofarbuild {
  ...
  cmake -DCMAKE_INSTALL_PREFIX=/localhome/lofar/$CASACOREVERSION -DUSE_HDF5=ON -DUSE_FFTW3=ON -DFFTW3_DISABLE_THREADS=OFF -DUSE_THREADS=ON -DUSE_OPENMP=ON -DDATA_DIR=/localhome/lofar/IERS/current/data .. > cmake.log
