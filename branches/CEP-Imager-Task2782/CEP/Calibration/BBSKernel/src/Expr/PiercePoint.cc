    ...
    const Vector<3>::View &direction, const Scalar::View &height) const
{
    ...
    double *pp_x = out_x.setDoubleFormat(1, nTime);
    double *pp_y = out_y.setDoubleFormat(1, nTime);
    double *pp_z = out_z.setDoubleFormat(1, nTime);
    double *pp_airmass = out_airmass.setDoubleFormat(1, nTime);
