//# GridderAlgorithm.h: Parallel residual image formation
...
#ifndef LOFARFT_GRIDDERALGORITHM_H
#define LOFARFT_GRIDDERALGORITHM_H
...
class GridderAlgorithm : public Algorithm {
 public:
