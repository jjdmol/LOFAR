...
#ifndef LOFAR_LOFARFT_LOFARATERMBEAM_H
#define LOFAR_LOFARFT_LOFARATERMBEAM_H
...
namespace LOFAR
{
  ...
  class LofarATermBeam : public LofarATerm
  {
  public:
    LofarATermBeam(const casa::MeasurementSet &ms,
