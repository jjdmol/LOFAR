...
namespace LOFAR {
  ...
  namespace DPPP {
    ...
    private:
      ...
      casa::Matrix<casa::DComplex> stefcal(string mode, uint solint=1);
      ...
      vector<casa::Matrix<casa::DComplex> > itsSols; // for every timeslot, nFreqCells times nSt gains with vector of length nCr values
