//#  -*- mode: c++ -*-
//#
//#  GetDatastreamCmd.h: enable/disable datastream to cep.
//#
//#  Copyright (C) 2009
...
//#
//#  $Id: GetDatastreamCmd.h 12869 2009-03-12 11:19:55Z overeem $

#ifndef GETDATASTREAMCMD_H_
#define GETDATASTREAMCMD_H_
...
class GetDatastreamCmd : public Command
{
public:
	// Constructors for a GetDatastreamCmd object.
	GetDatastreamCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);

	// Destructor for GetDatastreamCmd. */
	virtual ~GetDatastreamCmd();
...
private:
	...
	RSPGetdatastreamEvent* itsEvent;
};

  }; // namespace RSP
}; // namespace LOFAR
     
#endif /* GETDATASTREAMCMD_H_ */
