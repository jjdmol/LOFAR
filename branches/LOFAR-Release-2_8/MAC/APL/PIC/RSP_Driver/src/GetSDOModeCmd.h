//#  -*- mode: c++ -*-
//#
//#  GetSDOModeCmd.h: Beamformer Weights settings command.
//#
...
//#
//#  $Id: GetSDOModeCmd.h 13440 2009-06-22 13:26:54Z donker $

#ifndef GETSDOMODECMD_H_
#define GETSDOMODECMD_H_
...
namespace LOFAR {
  namespace RSP {
    ...
    class GetSDOModeCmd : public Command
    {
    public:
      /**
       * Constructors for a GetSDOModeCmd object.
       */
      GetSDOModeCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for GetSDOModeCmd. */
      virtual ~GetSDOModeCmd();
    ...
    private:
      ...
      RSPGetsdomodeEvent* itsEvent;
    };
  };
};
     
#endif /* GETSDOMODECMD_H_ */
