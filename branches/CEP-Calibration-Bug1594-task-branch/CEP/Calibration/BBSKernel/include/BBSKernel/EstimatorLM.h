//# EstimatorLM.h: Parameter estimation using the Levenberg-Marquardt algorithm.
//#
//# Copyright (C) 2010
...
#ifndef LOFAR_BBSKERNEL_ESTIMATORLM_H
#define LOFAR_BBSKERNEL_ESTIMATORLM_H

// \file
// Parameter estimation using the Levenberg-Marquardt algorithm.
...
//class EquationCommunicator
//{
//public:
//    typedef shared_ptr<EquationCommunicator>        Ptr;
//    typedef shared_ptr<const EquationCommunicator>  ConstPtr;

//    virtual ~EquationCommunicator()
//    {}

//    virtual void setSolvables(const ParmSet &solvables);

////    virtual void finalize() const
////    {}

//    template <typename T>
//    virtual void setInitialValues(T first, T last) const
//    {}

//    template <typename T>
//    virtual bool mergeAndIterate(T first, T last) const = 0;
//};

//class VisProcessor
//{
//    typedef shared_ptr<VisProcess>          Ptr;
//    typedef shared_ptr<const VisProcessor>  ConstPtr;
...
////    virtual setBaselineMask(const BaselineMask &mask);
////    {
////        itsBlMap.clear();
...
////    virtual setCorrelationMask(const CorrelationMask &mask);
////    {
////        itsCrMap.clear();
...
////    vector<pair<size_t, size_t> >   itsBlMap;
////    vector<pair<size_t, size_t> >   itsCrMap;
//};

class EstimatorLM
{
public:
    typedef shared_ptr<EstimatorLM>         Ptr;
    typedef shared_ptr<const EstimatorLM>   ConstPtr;

    EstimatorLM(const VisBuffer::Ptr &lhs, const MeasurementExpr::Ptr &rhs);
    ~EstimatorLM();
...
template <typename T_ITER>
Interval<size_t> EstimatorLM::makeAxisMap(const Axis::ShPtr &from,
    const Axis::ShPtr &to, T_ITER out) const
{
