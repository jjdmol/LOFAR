...
from lofarpipe.support.xmllogging import master_node_xml_decorator
...
class RemoteCommandRecipeMixIn(object):
    ...
    """
    @master_node_xml_decorator  # Wrapper enabling xml logging
    def _schedule_jobs(self, jobs, max_per_node=None): # Wrapper is backwards compatible
        """
