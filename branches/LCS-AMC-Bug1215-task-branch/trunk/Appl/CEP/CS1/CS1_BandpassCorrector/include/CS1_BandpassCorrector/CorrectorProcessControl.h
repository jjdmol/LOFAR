 ...
 ***************************************************************************/
#ifndef LOFARCORRECTORPROCESSCONTROL_H
#define LOFARCORRECTORPROCESSCONTROL_H
...
namespace LOFAR
{
  namespace CS1
  {
    ...
    class CorrectorProcessControl : public LOFAR::ACC::PLC::ProcessControl
    {
    private:
      std::string  itsMS;
      int          itsFixed;
    ...
    }; //class CorrectorProcessControl
  } //namespace CS1_Corrector
}; //namespace LOFAR
