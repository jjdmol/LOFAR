...
void pack(size_t nStation, const vector<size_t> &directions,
    const_cursor<double> in, cursor<double> out)
{
...
void estimate2(size_t nDirection, size_t nStation, size_t nBaseline, size_t nChannel,
...
//    // Pack unknowns.
//    boost::multi_array<double, 1> unknowns_packed(boost::extents[nUnknowns]);
//    pack(nStation, directions, unknowns, cursor<double>(&(unknowns_packed[0])));
...
//    LOG_DEBUG_STR("unknowns[0]: " << unknowns_packed[0] << " errors[0]: " << errors_packed[0] << " SD: " << solver.getSD());

    // Unpack unknowns and errors.
//    unpack(nStation, directions, const_cursor<double>(&(unknowns_packed[0])),
//        unknowns);
//    unpack(nStation, directions, const_cursor<double>(&(errors_packed[0])),
//        errors);
