...
class DataProcessorDefault(DataProcessorBase):
    ...
    def _create_processor(self, measurement, options) :
        """
        Overload this method with a method that sets _processor to an instance
        of a class derived from DataProcessorLowLevelBase.
        """
    ...
    def residual(self, coordinates, model, normalization_model =
        ...
        return (self.normalize(coordinates, residual, Normalization.FLAT_NOISE,
            normalization_residual), weight)
