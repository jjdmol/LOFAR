...
void CubeSkyEquation::oldInitializePutSlice(
  const casa::VisBuffer& vb, 
  Bool /*dopsf*/, 
  Int cubeSlice, 
  Int nCubeSlice) 
...
void CubeSkyEquation::newInitializePutSlice(
  const casa::VisBuffer& vb, 
  Bool dopsf, 
  Int cubeSlice, 
  Int nCubeSlice) 
...
Bool CubeSkyEquation::isNewFTM(casa::FTMachine* ftm)
{
  return (
...
void CubeSkyEquation::newFinalizePutSlice(
  const casa::VisBuffer& vb,  
  Bool dopsf,
  Int cubeSlice, 
  Int nCubeSlice) 
...
void CubeSkyEquation::oldFinalizePutSlice(
  const casa::VisBuffer& vb,  
  Bool /*dopsf*/,
  Int cubeSlice, 
  Int nCubeSlice) 
...
void CubeSkyEquation::newInitializeGetSlice(
  const casa::VisBuffer& vb, 
  Int /*row*/, 
  Bool incremental, 
  Int cubeSlice, 
...
void CubeSkyEquation::oldInitializeGetSlice(
  const casa::VisBuffer& vb, 
  Int row, 
  Bool incremental, 
  Int cubeSlice, 
