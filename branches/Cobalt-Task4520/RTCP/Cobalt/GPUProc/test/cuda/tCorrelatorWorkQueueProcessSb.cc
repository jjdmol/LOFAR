...
int main() {
  ...
  ptx[kfilenameFIR] = createPTX(kfilenameFIR, flags, definitions, devices);
  ptx[kfilenameDBP] = createPTX(kfilenameDBP, flags, definitions, devices);
  ptx[kfilenameCor] = createPTX(kfilenameCor, flags, definitions, devices);
