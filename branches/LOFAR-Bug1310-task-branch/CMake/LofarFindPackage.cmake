...
#    set_property(GLOBAL APPEND PROPERTY LOFAR_DEFINITIONS HAVE_${_PKG})
  ...
  message(STATUS "${_package}_INCLUDE_DIR = ${${_package}_INCLUDE_DIR}")
  message(STATUS "${_package}_LIBRARY = ${${_package}_LIBRARY}")
  message(STATUS "${_package}_FOUND = ${${_package}_FOUND}")
  message(STATUS "HAVE_${_package} = ${HAVE_${_package}}")
