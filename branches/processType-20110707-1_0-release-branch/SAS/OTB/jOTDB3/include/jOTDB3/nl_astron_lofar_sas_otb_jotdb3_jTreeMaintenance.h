...
JNIEXPORT jboolean JNICALL Java_nl_astron_lofar_sas_otb_jotdb3_jTreeMaintenance_exportTree__IILjava_lang_String_2IZ (JNIEnv *env, jobject, jint, jint, jstring, jint, jboolean);
JNIEXPORT jboolean JNICALL Java_nl_astron_lofar_sas_otb_jotdb3_jTreeMaintenance_exportTree__IILjava_lang_String_2I (JNIEnv *env, jobject, jint, jint, jstring, jint);
JNIEXPORT jboolean JNICALL Java_nl_astron_lofar_sas_otb_jotdb3_jTreeMaintenance_exportTree__IILjava_lang_String_2 (JNIEnv *env, jobject, jint, jint, jstring);
