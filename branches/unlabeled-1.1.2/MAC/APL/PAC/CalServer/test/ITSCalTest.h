//#  -*- mode: c++ -*-
//#
//#  ITSCalTest.h: class definition for the ITSCALTest program
//#
...
#ifndef ITSCALTEST_H_
#define ITSCALTEST_H_
  ...
  namespace CAL
    {
      ...
      class ITSCalTest : public GCFTask, public Test
	{
	public:
	  /**
	   * The constructor of the ITSCalTest task.
	   * @param name The name of the task. The name is used for looking
	   * up connection establishment information using the GTMNameService and
	   * GTMTopologyService classes.
	   */
	  ITSCalTest(string name);
	  virtual ~ITSCalTest();
