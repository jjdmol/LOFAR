//# tSlidingFlagger.cc: Test program for class SlidingFlagger
//# Copyright (C) 2010
...
//#
//# $Id: tSlidingFlagger.cc 24221 2013-03-12 12:24:48Z diepen $
//#
...
void test1(int ntime, int nant, int nchan, int ncorr, bool flag, int threshold)
{
  ...
  parset.add ("buffersize", "1");
  DPStep::ShPtr step2(new SlidingFlagger(in, parset, ""));
