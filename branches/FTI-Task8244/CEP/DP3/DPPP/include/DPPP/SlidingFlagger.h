...
#ifndef DPPP_SLIDINGFLAGGER_H
#define DPPP_SLIDINGFLAGGER_H
...
namespace LOFAR {
  ...
  namespace DPPP {
    ...
    private:
      struct ThreadData {
        boost::shared_ptr<rfiStrategy::Strategy> strategy;
      ...
      struct BLData {
        Image2DPtr realXX;     //# data per baseline
        Image2DPtr imagXX;
        Image2DPtr realXY;
        Image2DPtr imagXY;
        Image2DPtr realYX;
      ...
      vector<BLData>        itsBLData;   //# data per baseline
