//#  -*- mode: c++ -*-
//#
//#  SetSDOCmd.h: Beamformer Weights settings command.
//#
...
//#
//#  $Id: SetSDOCmd.h 7595 2006-02-07 07:46:25Z overeem $
...
namespace LOFAR {
  namespace RSP {
    ...
    class SetSDOCmd : public Command
    {
    public:
      /**
       * Constructors for a SetSDOCmd object.
       */
      SetSDOCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for SetSDOCmd. */
      virtual ~SetSDOCmd();
