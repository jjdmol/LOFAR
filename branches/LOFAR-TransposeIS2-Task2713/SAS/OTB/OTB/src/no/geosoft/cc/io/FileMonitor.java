 ...
 *
 * Adapted by blaakmeer to make the code JDK 1.5 compliant: All collections
 * use Java Generics to make them typesafe.
 */   
public class FileMonitor
{
  private Timer                     timer_;
  private HashMap<File,Long>        files_;       // File -> Long
  private Collection<WeakReference> listeners_;   // of WeakReference(FileListener)
