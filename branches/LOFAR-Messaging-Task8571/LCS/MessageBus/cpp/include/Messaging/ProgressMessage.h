//# ProgressMessage.h: Message class used for progress messages. 
//#
//# Copyright (C) 2015
...
//#
//# $Id: ProgressMessage.h 1483 2015-08-23 19:19:44Z loose $

#ifndef APERTIF_MESSAGING_PROGRESSMESSAGE_H
#define APERTIF_MESSAGING_PROGRESSMESSAGE_H

// @file
// Message class used for progress messages. 
...
namespace APERTIF
{
  namespace Messaging
  {
    ...
    class ProgressMessage : public ApertifMessage
    {
    public:
      // Default constructor.
      ProgressMessage();
    ...
    private:
      ...
      ProgressMessage(const qpid::messaging::Message& qmsg);
