...
def footer(req, first_line_indent = '', line_indent = '', indent = '    '):
    ...
    print
    print line_indent + 0 * indent + '<p class="copyright-notice">Copyright &copy; 2004-2006 <a href="http://www.astron.nl">Netherlands Foundation For Research In Astronomy (ASTRON)</a> and <a href="http://www.science-and-technology.nl">Science and Technology BV, The Netherlands</a>.</p>'
    print
