...
def test_environment(lofarroot,pipeline,datadir):
    ...
    # test if the testdata dir is present (do not test the full tree just the
    # parset)
...
def validate_output(lofarroot,pipeline,workdir,testdata,host0=None,host1=None,host2=None):
    ...
    #subprocess.call(['python',script_path + '/' + pipeline + '_test.py',workdir +
    #'/target_data/*',workdir + 'output_data/*','0.0001'])
...
if __name__ == '__main__':
    ...
    # if running in Jenkins environment $Workspace is defined and pointing to
    # LOFARROOT
