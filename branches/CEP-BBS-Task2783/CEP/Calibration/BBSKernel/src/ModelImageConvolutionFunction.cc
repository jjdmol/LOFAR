...
//#
//# $Id: LofarConvolutionFunction.cc 18951 2011-10-06 14:21:03Z diepen $
...
//      m_refFrequency = observationReferenceFreq(ms, 0);
    ...
    list_freq   = Vector<Double>(1, m_refFrequency);
    m_nChannel  = list_freq.size();
    // TODO: need to change this to be independent of ms! ONLY needed for A-term
//    ROMSAntennaColumns antenna(ms.antenna());
//    m_nStations = antenna.nrow();
